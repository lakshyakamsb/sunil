    ...
    <div>
      ...
      <div className="container">
        <div className="row">
          ...
          {renderCard("image/card3.jpeg", "Acupuncture", "Acupuncture involves inserting very thin needles into the body at different locations and depths. It aims to balance the life forces known as Qi that are responsible for different health issues. Acupuncture can help relieve pain and treat a range of other complaints.")}
        </div>
      </div>

      <div className="container">
        <div className="row">
          {renderCard("image/card4.jpeg", "Cupping", "Cupping therapy is an ancient form of alternative medicine in which a therapist puts special cups on your skin for a few minutes, creating suction. People get it for many purposes, including inflammation, improving blood flow, relaxation, and well-being, and deep tissue massage.")}
